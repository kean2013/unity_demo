...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_SceneManagement_Scene_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_buildIndex_0);
        ...
        static StackObject* get_buildIndex_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
