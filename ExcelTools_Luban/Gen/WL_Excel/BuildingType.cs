...
public sealed partial class BuildingType :  Bright.Config.BeanBase 
{
    public BuildingType(JSONNode _json) 
    {
    ...
    public BuildingType(int id, string name, string desc, int price, int upgrade_to_item_id, int? expire_time, bool batch_useable, item.EQuality quality, item.ItemExchange exchange_stream, System.Collections.Generic.List<item.ItemExchange> exchange_list, item.ItemExchange exchange_column ) 
    {
        this.Id = id;
        this.Name = name;
        this.Desc = desc;
    ...
    public static BuildingType DeserializeBuildingType(JSONNode _json)
    {
        return new WL_Excel.BuildingType(_json);
    }
    ...
    public const int __ID__ = -863617073;
