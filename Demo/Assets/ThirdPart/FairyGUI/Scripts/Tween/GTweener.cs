...
namespace FairyGUI
{
    ...
    public class GTweener
    {
        ...
        public TweenPropType _propType;
        public bool _killed;
        public bool _paused;
        ...
        public GTweener _To(float start, float end, float duration)
        {
            _valueSize = 1;
            _startValue.x = start;
            _endValue.x = end;
        ...
        public GTweener _To(Vector2 start, Vector2 end, float duration)
        {
            _valueSize = 2;
        ...
        public GTweener _To(Vector3 start, Vector3 end, float duration)
        {
            _valueSize = 3;
        ...
        public GTweener _To(Vector4 start, Vector4 end, float duration)
        {
            _valueSize = 4;
        ...
        public GTweener _To(Color start, Color end, float duration)
        {
            _valueSize = 4;
        ...
        public GTweener _To(double start, double end, float duration)
        {
            _valueSize = 5;
            _startValue.d = start;
            _endValue.d = end;
        ...
        public GTweener _Shake(Vector3 start, float amplitude, float duration)
        {
            _valueSize = 6;
            _startValue.vec3 = start;
