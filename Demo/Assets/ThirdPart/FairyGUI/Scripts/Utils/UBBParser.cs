...
namespace FairyGUI.Utils
{
    ...
    public class UBBParser
    {
        ...
        public UBBParser()
        {
            ...
            handlers["audio"] = onTag_Audio;
            handlers["avatar"] = onTag_Avatar;
            handlers["event"] = onTag_Event;
        }
        ...
        protected string onTag_Audio(string tagName, bool end, string attr)
        {
            string src = GetTagText(true);
        ...
        protected string onTag_Avatar(string tagName, bool end, string attr)
        {
            string src = GetTagText(true);
            if (src == null || src.Length == 0) return null;
        ...
        protected string onTag_Event(string tagName, bool end, string attr)
        {
            string src = GetTagText(true);
            if (src == null || src.Length == 0) return null;
