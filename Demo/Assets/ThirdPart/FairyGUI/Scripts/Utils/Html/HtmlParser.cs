            ...
            while (XMLIterator.NextTag())
            {
                ...
                switch (XMLIterator.tagName)
                {
                    ...
                    case "avatar":
                        ...
                        HtmlElementType t = XMLIterator.tagName == "audio" ? HtmlElementType.Audio 
                            : XMLIterator.tagName == "avatar" ? HtmlElementType.Avatar : HtmlElementType.Event;
                        if (XMLIterator.tagType == XMLTagType.Start || XMLIterator.tagType == XMLTagType.Void)
                        {
                            HtmlElement element = HtmlElement.GetElement(t);
